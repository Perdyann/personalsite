...
<tr>
<td>
<input type="text" readonly="readonly" value="<?php echo $get['fname']."&nbsp;".$get['lname']."&nbsp;".$get['mi']; ?>" name="name" style="width:200px; padding:4px;" onclick="clear()" class="search" id="searchbox" />
</td><td>
